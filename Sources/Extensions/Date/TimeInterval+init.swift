...
public extension TimeInterval {
    ...
    /// [Common]
    static func milliseconds(_ v: Double) -> TimeInterval { v * millisecond }
    /// [Common]
    static func seconds(_ v: Double) -> TimeInterval { v * second }
    /// [Common]
    static func minutes(_ v: Double) -> TimeInterval { v * minute }
    /// [Common]
    static func hours(_ v: Double) -> TimeInterval { v * hour }
    /// [Common]
